...
class Profile extends Component {
    ...
    onUpdateNameClick = () => {
        this.state.updateFullName === '' ? this.setState({ fullnameRequired: 'dispBlock' }) : this.setState({ fullnameRequired: 'dispNone' });
    ...
    onAddCommentClick = () => {
        ...
        if (this.state.newComment === "") {
            ...
            let _postSelectedItem = this.state.postSelected;
            _postSelectedItem.comments['data'] = _postSelectedItem.comments['data'] || [];
                ...
                <Container fixed>
                                        ...
                                        <div className={classes.paper}>
                                            ...
                                            <FormControl required className="formControl">
                                                ...
                                                <Input id="userfullname" type="text"
                                                    onChange={this.onFullNameChange} value={this.state.updateFullName} />
                                                <FormHelperText className={this.state.fullnameRequired}>
                                                    <span className="red">Required</span>
                                                </FormHelperText>
                                            </FormControl><br /><br />
                                            <Button variant="contained" color="primary" style={{ width: 10 }} onClick={this.onUpdateNameClick}>UPDATE</Button>
                                        </div>
                                    </Modal>
                                </Grid>
                            </Grid>
                    ...
                    <GridList cellHeight={320} cols={3} >
                        {(this.state.userPosts || []).map((post, index) => (
                            <GridListTile key={post.id} className="grid-content" onClick={() => this.onhandlePostClick(post.id, index)}>
                        ...
                        >
                            <div className={classes.paper_big}>
                                <Grid container spacing={3}>
                                    <Grid item xs={6}>
                                        <img src={this.state.postSelected.images.standard_resolution.url} width="100%" alt={(this.state.postSelected.caption.text).split('\n')[0]} />
                                    </Grid>
                                    <Grid item xs={6}>
                                        <Grid container spacing={3} justify="flex-start" alignItems="center">
                                            <Grid item >
                                                <Avatar src={this.state.postSelected.user.profile_picture} alt={this.state.postSelected.user.username} />
                                            </Grid>
                                            <Grid item >
                                                <Typography variant="subtitle2">
                                        ...
                                        <Grid container spacing={1} justify="flex-start" alignItems="center">
                                            <Grid item className="min-height-comments-box">
                                                {(this.state.postSelected.comments.data || []).map((comment, i) => {
                                        ...
                                        <Grid container spacing={1} justify="flex-start" alignItems="center">
                                            <Grid item >
                                                <Favorite className={this.state.postSelected.user_has_liked ? 'greyLike' : 'redLike'} onClick={this.onLikesClick} />
                                            </Grid>
                                            <Grid item >
                                                <Typography variant="caption">
                                        ...
                                        <Grid container spacing={2} justify="flex-start" alignItems="center">
                                            <Grid item >
                                                <FormControl className="formControl">
                                                    ...
                                                    <Input id="addcomment" type="text" onChange={this.onAddCommentChange} value={this.state.newComment} />
                                                </FormControl>
                                            </Grid>
                                            <Grid item >
                                                <Button variant="contained" color="primary" onClick={this.onAddCommentClick}>ADD</Button>
                                            </Grid>
                                        </Grid>
